...
<?php
  ...
  $query1="SELECT  * from products WHERE status='APPROVED' AND category='Computer Waste' AND sid=$_SESSION[sid]";
  $result1=mysqli_query($connect,$query1);
  $v1=mysqli_num_rows($result1);

  $query2="SELECT  * from products WHERE status='APPROVED' AND category='Mobile Waste' AND sid=$_SESSION[sid]";
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="productdetailsseller.php?pid=<?php echo $row2['pid']; ?>" title="More Details" target="_blank"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
