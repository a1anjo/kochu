...
// Check if the buyer has already requested this product
$checkQuery = "SELECT * FROM communication_requests WHERE pid='$pid' AND bid='$bid'";
$checkResult = mysqli_query($connect, $checkQuery);

if (mysqli_num_rows($checkResult) > 0) {
    // The buyer has already requested this product, show a message and redirect
    $message = "You have already requested this product.";
    echo "<script>alert('$message');</script>";
    echo "<script>window.location.replace('productsforbuyer.php');</script>";
} elseif (isset($_POST["send"])) {
    // The buyer hasn't requested this product, allow them to send a request
    $query = "INSERT INTO communication_requests(pid, bid, sid) VALUES ('$pid', '$bid', '$sid')";
        ...
        <div class="col-lg-6">
          <form method="post" >
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" id="email" class="form-control" required value="<?php echo $email?>" readonly>
            </div>
