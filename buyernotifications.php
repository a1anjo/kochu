...
// Query to fetch product name, seller name, and approval status
$query = $query = "SELECT communication_requests.rid, products.pid, products.title AS product_name, seller.scompany AS seller_name, communication_requests.approval_status
FROM communication_requests
INNER JOIN products ON communication_requests.pid = products.pid
INNER JOIN seller ON products.sid = seller.sid
WHERE communication_requests.bid = $_SESSION[bid]";
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        ...
        <ul>
          ...
          <li><a class="nav-link scrollto" href="buyernotifications.php">Notifications</a></li>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr>';
                            echo '<td><a href="productdetails.php?pid=' . $row['pid'] . '">' . $row['product_name'] . '</a></td>';
